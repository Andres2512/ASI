...
<html>
    ...
    <body>
        <div class="lead" style="font-size: 15px;">
            <small>
                <a href="">Inicio</a> > <a href="">Materiales y Herramientas</a> > <a href="">Registrar Marca</a>
                <hr style="background-color: gold;">
            </small>
        </div>
        <div class="container">
            <h1 class="h2 text-center my-5" style="font-family: Microsoft YaHei Light">REGISTRAR MARCA</h1>
            <form action="<%=request.getContextPath()%>/CtrMarca">
                <div class="form-group">
                    <label for="" class="control-label">Marca</label>
                    <input type="text" class="form-control" name="txtNombre" placeholder="Marca" required>
                </div>

                <div class="form-group"> 
                    <p><button type="submit" name="accion" class="btn btn-primary" value="btnAgregarMrca">Agregar Nueva Marca</button></p>
                </div>
            </form>
        </div>
        <!-- SCRPTS -->
