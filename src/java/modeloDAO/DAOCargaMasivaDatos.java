 ...
 * @author Daniel Avila
 */
public class DAOCargaMasivaDatos {
    ...
    public boolean cargaMasivaMarca(String archivo) {
        ...
        try {
            ...
            input.useDelimiter(",|\n");
            ps = cn.getConnection().prepareStatement("INSERT INTO Marca(nombre) values (?)");
            while (input.hasNext()) {
    ...
    public void cargaMasivaUsuarios(String archivo) {
        Scanner input;
        try {
            input = new Scanner(new File(archivo));
            input.useDelimiter(",|\n");
...
//        DAOCargaMasivaDatos aOCargaMasivaDatos = new DAOCargaMasivaDatos();
//        aOCargaMasivaDatos.cargaMasiva();
//    }
}
