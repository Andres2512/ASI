...
public class DTOEmpleado {
    ...
    public DTOEmpleado(int Id_usuario, String Nombres, String Apellidos, String Numero_celular, int Numero_telefono, String Correo, String Direccion, int Roles_Id_roles, int Ciudades_Id_ciudades, int Proyecto_Id_proyecto, String Contrasenia) {
