        ...
        <div class="wrapper">
            <nav id="sidebar">
                ...
                <ul style="font-size: 0.85em" class="list-unstyled components">
                    <p style="font-weight: bold; color: #F29F14" class="lead">Contratista</p>
                    <li>
            ...
            <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            <li class="nav-item active">
                                <a class="nav-link ml-4" href="<%= request.getContextPath()%>/ModuloContratista/InicioContratista.jsp">INICIO<span class="sr-only">(current)</span></a>
                            </li>
                        </ul>
                ...
                <div style="margin-top: -38px" role="main" class="col-md-12 ml-sm-auto col-lg-12 px-2">
                    <section class="">
                        <iframe name="workSection" src="BienvenidoContratista.jsp"></iframe>
                    </section>
                </div>    
            </div>
