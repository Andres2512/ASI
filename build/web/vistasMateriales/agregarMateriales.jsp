...
<html>
    ...
    <body>
        <div class="lead" style="font-size: 15px;">
            <small>
                <a href="">Inicio</a> > <a href="">Materiales y Herramientas</a> > <a href="">Registrar Materiales</a>
                <hr style="background-color: gold;">
            </small>
        </div>
        <div class="container">
            <h1 class="h2 text-center my-5" style="font-family: Microsoft YaHei Light">REGISTRAR MATERIALES</h1>
            <form action="<%=request.getContextPath()%>/CtrMateriales">
                ...
                <div class="form-group"> 
                    <p><button type="submit" name="accion" class="btn btn-primary" value="btnAgregarMtl">Agregar Material</button></p>
                </div>
            </form>
        </div>
        <!-- SCRPTS -->
